  ...
  return (
    <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
            ...
            ></video>
            <VStack>
                <Heading>Sample vedio 1</Heading>
                <Text>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore sequi qui odit modi nulla, quaerat accusantium quibusdam, incidunt facilis quod atque quis non adipisci veritatis!</Text>
            </VStack>
        </VStack>
        {/* Stretch=gap property of css */}
        <VStack w={['full','xl']} 
        alignItems={"stretch"} 
        p={"8"} 
        overflowY={"auto"}> 
